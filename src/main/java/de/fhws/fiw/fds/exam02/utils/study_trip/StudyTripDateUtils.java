...
public class StudyTripDateUtils
{
	...
	public StudyTripDateUtils(final StudyTrip studyTrip, final LocalDate intervalStart, final LocalDate intervalEnd)
	{
	...
	{
		return date.isEqual(this.intervalStart) || (date.isAfter(this.intervalStart) && date.isBefore(this.intervalEnd))
